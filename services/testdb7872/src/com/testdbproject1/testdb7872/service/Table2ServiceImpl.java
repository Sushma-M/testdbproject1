 ...
 */
@Service("testdb7872.Table2Service")
public class Table2ServiceImpl implements Table2Service {
    ...
    @Autowired
    @Qualifier("testdb7872.Table2Dao")
    ...
    public void setWMGenericDao(WMGenericDao<Table2, Integer> wmGenericDao){
     ...
     @Transactional(readOnly = true, value = "testdb7872TransactionManager")
    ...
    @Transactional(rollbackFor = EntityNotFoundException.class, value = "testdb7872TransactionManager")
    @Override
