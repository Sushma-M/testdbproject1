...
import com.testdbproject1.testdb7872.service.Table1Service;
 ...
 * @see com.testdbproject1.testdb7872.Table1
 */

@RestController(value = "Testdb7872.Table1Controller")
@Api(value = "/testdb7872/Table1", description = "Exposes APIs to work with Table1 resource.")
@RequestMapping("/testdb7872/Table1")
public class Table1Controller {

    private static final Logger LOGGER = LoggerFactory.getLogger(Table1Controller.class);

	@Autowired
	@Qualifier("testdb7872.Table1Service")
