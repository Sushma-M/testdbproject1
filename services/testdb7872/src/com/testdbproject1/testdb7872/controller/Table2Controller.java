...
import com.testdbproject1.testdb7872.service.Table2Service;
...
import com.testdbproject1.testdb7872.*;
import com.testdbproject1.testdb7872.service.*;


/**
 * Controller object for domain model class Table2.
 * @see com.testdbproject1.testdb7872.Table2
 */

@RestController(value = "Testdb7872.Table2Controller")
@Api(value = "/testdb7872/Table2", description = "Exposes APIs to work with Table2 resource.")
@RequestMapping("/testdb7872/Table2")
public class Table2Controller {

    private static final Logger LOGGER = LoggerFactory.getLogger(Table2Controller.class);

	@Autowired
	@Qualifier("testdb7872.Table2Service")
